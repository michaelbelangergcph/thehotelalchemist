      ...
      <section className="section section--navy closing" id="contact">
        <Reveal className="closing__inner">
          ...
          <p className="closing__copy">
            <p>For centuries, alchemists searched for a way to transform ordinary metals into gold. But alchemy was never only about precious metal. It was about transformation: understanding the hidden properties of raw materials, combining art with science, and turning potential into something exceptional.</p>

<p>The Hotel Alchemist applies that same philosophy to hospitality.</p>
