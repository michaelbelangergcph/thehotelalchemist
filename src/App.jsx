      ...
      <section className="hero">
        <div className="hero__content">
          ...
          <p className="hero__sub">
           <p>Alchemy is the art of transformation: turning ordinary materials into something rare and valuable. </p>p>
      ...
      <section className="section section--navy closing" id="contact">
        <Reveal className="closing__inner">
          ...
          <p className="closing__copy">
            <p>For centuries, alchemists searched for a way to transform ordinary metals into gold. But alchemy was never only about precious metal. It was about transformation: understanding the hidden properties of raw materials, combining art with science, and turning potential into something exceptional.</p>p>

<p>The Hotel Alchemist applies that same philosophy to hospitality.</p>p>
